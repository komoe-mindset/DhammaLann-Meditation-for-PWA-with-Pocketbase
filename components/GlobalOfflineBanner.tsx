      ...
      {!isOnline && (
        ...
        >
          <div className="flex justify-center p-2">
            <div className="bg-red-500/90 backdrop-blur-md text-white text-[10px] px-4 py-2 rounded-full font-bold shadow-lg flex items-center gap-2 border border-red-400/50 pointer-events-auto">
