...
const UpNextCard: React.FC<UpNextCardProps> = ({ nextAudio, currentStreak, t, lang }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -inset-1 bg-gradient-to-r from-[#D4AF37]/20 to-[#B8860B]/20 rounded-[2rem] md:rounded-[2.5rem] blur-xl opacity-50 group-hover:opacity-75 transition duration-1000 group-hover:duration-200"></div>
      ...
      <div className="glass-card relative rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-10 border-2 border-[#D4AF37]/50 shadow-2xl overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8">
          ...
          >
            ...
            <div className="relative z-10 w-7 h-7 md:w-10 md:h-10 bg-white/20 rounded-full flex items-center justify-center">
