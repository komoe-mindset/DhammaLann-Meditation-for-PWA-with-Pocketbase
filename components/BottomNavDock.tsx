      ...
      <div className="glass-card rounded-full p-2 border-2 border-[#D4AF37]/30 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex items-center justify-between gap-2 backdrop-blur-xl bg-black/40 relative">
        ...
        {!isStandalone && (
          ...
          >
            ...
            <span className="text-xs font-bold text-white/60 uppercase tracking-tighter">Install</span>
          </button>
        )}
        ...
        >
          ...
          <span className="text-xs font-bold text-white/60 uppercase tracking-tighter">Language</span>
        </button>
        ...
        >
          ...
          <span className="text-xs font-bold uppercase tracking-tighter text-white/60">Admin</span>
        </button>
      </div>
    </nav>
  );
